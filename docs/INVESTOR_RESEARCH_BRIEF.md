...
## Folders we checked and what mattered

| Path under `~/Documents/` | Use for investors |
|---------------------------|--------------------|
...
- **Wedge (Design Compass + Gharr):** the bottleneck is not “more inspiration.” It is **clarity, feasibility, and explicit approval** → **locked scope and estimate** → **milestones and visibility**. Stage **GTM and marketplace** only after **paid** proof on **clarity** (staged model in the business plan).

### Numbers to memorize (orders of magnitude)

| Signal | ~Order |
|--------|--------|
| India total construction (2024) | **$687B** |
| Residential (2024 / ’25) | **~$190B** / **~$264–404B** |
| Interior / improvement / remodel | **~$24–36B** / **~$34.7B** / **~$12.3B** |
| Renos / year; online home services | **~5M**; **~0.8%** online |
| Coordination layer on envelope | **~$1.5–2.5B+** (conservative) |

### Competitors (one line each)

- **Managed interiors** — own **execution** for a **slice**; not the long tail’s OS.  
- **Service marketplaces** — **discovery**; not full **pre-execution** truth on scope.  
- **Inspiration / listings** — **do not** close the **approval + estimate** loop.  

*(Named revenue, funding, and global comps: business plan.)*

### Ask and deck

- **Slide narrative, team frame, and $5M-style ask** are drafted in `~/Documents/design-compass/docs/investor_pitch_deck.md`. Align structure with counsel.  
- **Longer in-repo pitch / slide map:** [INVESTOR_PITCH.md](./INVESTOR_PITCH.md).
